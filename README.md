...
### Тест-кейсы
Таблица 1. Тест-кейс выбора папки с аудиофайлами

![Снимок экрана 2024-06-03 112007](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/c94edf21-5609-4979-a19e-b0438a2ebdf0)

Таблица 2. Тест-кейс прослушивания аудиофайлов

![Снимок экрана 2024-06-03 112014](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/29be2b5d-18ee-46b8-a509-6bd0a81bc2d4)

Таблица 3. Тест-кейс перемешивания песен

![Снимок экрана 2024-06-03 112027](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/299e1411-b7ee-4889-92b0-93033b03fb35)

Таблица 4. Тест-кейс повтора песен

![Снимок экрана 2024-06-03 112032](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/d0b0bfcd-7ac2-4df0-bb55-2297351a3b7a)

Таблица 5. Тест-кейс переключения песен

![Снимок экрана 2024-06-03 112038](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/d0acdada-05bb-4841-b331-f1977762c6a6)

Таблица 6. Тест-кейс включения паузы

![Снимок экрана 2024-06-03 112044](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/cc83c273-39ec-45cd-966b-b7cae09e4594)

Таблица 7. Тест-кейс регулировки громкости

![Снимок экрана 2024-06-03 112050](https://github.com/Lisichnikov/AudioPlayer_Worked/assets/117975390/cb5e4fc5-8910-42eb-a097-7d95f0794688)

## Contributing
Сообщения о багах и ошибках присылать на почту: alexochanel@gmail.com

## FAQ 
### Как найти кнопку "Выбор папки"?
- Она находится слева сверху на главном окне.
...
## To do
- [x] Реализовать открытие аудиофайлов
- [x] Реализовать прослушивание аудиофайлов
- [x] Реализовать перемешивание композиций
- [x] Реализовать повтор композиций
- [x] Реализовать переключение композиций
- [x] Реализовать регулирование уровня звука внутри приложения
- [x] Реализовать возможность поставить композицию на паузу
